...
tag_input_fastq = dirname(snakemake.input.cleaned_fastq) + "/" + snakemake.wildcards.sample + snakemake.wildcards.read_pair_tags + ".fastq.gz"
...
if snakemake.wildcards.read_pair_tags == "":
    zip_out_basename = "SE_fastqc.zip"
else:
    zip_out_basename = snakemake.wildcards.read_pair_tags.replace("_","") + "_fastqc.zip"
